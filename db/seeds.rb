...
listing1= Listing.create(title: 'cool house 147' , description: 'very cool', host_id:user1.id, address: '123 grand st', city: 'NY', state: 'New York', zipcode: '10012', latitude: '40.615442', longitude:'-73.993055', max_num_guests: 2, num_beds: 2, num_baths: 1, price_per_night: 99)

listing2= Listing.create(title: 'The Aight House', description: 'IT\'S AIGHT I GUESS', host_id:user2.id, address: '421 Monmouth St', city: 'MIA', state: 'Florida', zipcode: '08609', latitude: '25.770545', longitude:'-80.313126', max_num_guests: 1, num_beds: 1, num_baths: 1, price_per_night: 77)

listing3= Listing.create(title: 'National at 888 Sixth Avenue - Studio' , description: 'Entire rental unit hosted by National Corporate Housing', host_id:user1.id, address: '123 14th st', city: 'ATX', state: 'Texas', zipcode: '10012', latitude: '30.288667', longitude:'-97.694867', max_num_guests: 5, num_beds: 5, num_baths: 3, price_per_night: 205)

listing4= Listing.create(title: 'Entire Apartment - Spacious 1 BR in West Village' , description: 'Entire rental unit hosted by Austin', host_id:user2.id, address: '246 2846792nd st', city: 'LA', state: 'California', zipcode: '10012', latitude: '34.055107', longitude:'-118.195265', max_num_guests: 4, num_beds: 2, num_baths: 1, price_per_night: 155)
