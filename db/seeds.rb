...
booking1 = Booking.create(guest_id: user2.id, listing_id:listing3.id, check_in_date:Date.new(2099, 4, 20).to_formatted_s(:number).to_i, check_out_date: Date.new(2100, 4, 20).to_formatted_s(:number).to_i, num_guests: 420, total_price: 42069)